<script>
    ...
    const listOneLine = [
        {
            text: 'Первичная консультация: составляем план вашей перепланировки',
            icon: 'check_circle_outline',
        },
        {
            text: 'Общение с жилищными органами: получаем всю доступную документацию по вашему дому, представляем организациям наши планы по перепланировке',
            icon: 'check_circle_outline',
        },
        {
            text: 'Согласование: утверждаем вашу перепланировку в соответствующих структурах',
            icon: 'check_circle_outline',
        },
        {
            text: 'Внесение изменений: корректируем наши планы в соответствии с решением жилищных органов и проектных организаций',
            icon: 'check_circle_outline',
        },
    ];
</script>
...
<svelte:head>
    <title>ОФОРМЛЕНИЕ ПЕРЕПЛАНИРОВКИ</title>
</svelte:head>
    ...
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="text-xl mt-4 text-justify">
                        Перепланировка квартиры – вещь желанная для многих владельцев, однако вместе
                        с тем рискованная по разным причинам. Большую часть хоть сколь-нибудь
                        значительных изменений необходимо согласовывать с соответствующими
                        муниципальными структурами. В противном случае есть серьёзная вероятность
                        того, что вас обложат штрафами, а недвижимость изымут и продадут на
                        аукционе. Мы поможем избежать этого! Проконсультируем вас и расскажем, какие
                        изменения можно осуществлять без согласования, а какие нельзя. Более того,
                        всё взаимодействие с проектными организациями и жилищными органами мы также
                        берём на себя.
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content
                                leadmes="Перепланировка квартиры"
                                knoblabel="СОБИРАЮСЬ ДЕЛАТЬ ПЕРЕПЛАНИРОВКУ" />
                        </Modal>
                    </div>
                </div>
            ...
            <div class="text-xl text-justify">
                Наказание за незаконную перепланировку может быть очень серьёзным, поскольку она
                может угрожать безопасности всех жильцов дома. Изменения, затрагивающие конфигурацию
                помещений, требуют самой тщательной проверки. Например, ни в коем случае нельзя
                каким либо образом трогать несущую стену здания, поскольку манипуляции с ней могут
                создать риск обрушения всего строения. Мы запросим чертежи вашего дома в управляющей
                компании и выясним, какая стена является несущей. Таким образом, можно будет уже на
                этапе планирования внести изменения в ваш план ремонта и обновления квартиры.
                <br /><br />
                Некоторые виды работ согласовываются довольно легко, однако практически каждый из
                них обладает рядом нюансов, которые следует учитывать. Не стоит пренебрегать
                услугами специалистов, если вы планируете перепланировку. Кроме того, учитывайте,
                что у вашего дома есть свои индивидуальные особенности и требования, которые
                необходимо уточнять в конструкторское бюро и Бюро технической инвентаризации.
                <br /><br />
                <b>Наш план работы:</b>                
                <List items={listOneLine} />
                <br /><br />
                Свяжитесь с нашими специалистами и забудьте о проблемах, связанных с перепланировкой квартиры!
            </div>
            <div class="mt-5 mb-6 h-10 duration-100">
                <Modal>
                    <Content
                        leadmes="Перепланировка квартиры"
                        knoblabel="НАПИСАТЬ НАМ" />
                </Modal>
            </div>
            <div class="text-xl text-justify">
