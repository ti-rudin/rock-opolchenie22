...
<svelte:head>
    <title>ЗАКОННО СПИШЕМ ДОЛГИ ЧЕРЕЗ ПРОЦЕДУРУ БАНКРОТСТВА</title>
</svelte:head>
    ...
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    <div class="md:text-4xl text-2xl uppercase font-black">
                        ЗАКОННО СПИШЕМ ДОЛГИ ЧЕРЕЗ ПРОЦЕДУРУ БАНКРОТСТВА
                    </div>
                    <div class="text-xl mt-4">
                        Банкротство физических лиц — легальный инструмент освобождения от всех долгов перед банками, МФО, частными кредиторами
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="ХОЧУ СТАТЬ БАНКРОТОМ!" />
                        </Modal>
                    </div>
                </div>
            ...
            <div class="text-xl">
                ...
                Правовой анализ ситуации — процедура ознакомления юриста с особенностями дела
                клиента (оформление наследства, земельный или жилищный спор, взыскание задолженности
                и пр.). В ходе работы специалист:
                ...
                сформированная на начальных этапах работы позиция и продуманная стратегия поведения
                заметно повышают возможность успешного решения проблем клиента.
            </div>
        </div>
    </div>
</section>
