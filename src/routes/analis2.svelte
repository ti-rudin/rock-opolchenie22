...
<section class="py-5 px-5">
    <div class="container m-auto px-12 sm:px-12 flex flex-col-reverse sm:flex-row relative">
        <div class="sm:w-7/12 relative z-10">
                    ...
                    <svg
                        ...
                        viewBox="0 0 1093.86671 645.61588"><path
                        ...
                        <path
                            ...
                            transform="translate(-153.06664 -127.19206)"
                            fill="#2f2e41" />
                        <circle cx="797.16693" cy="314.52053" r="50.12206" fill="#6c63ff" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-153.06664 -127.19206)"
                            fill="#3f3d56" />
                        <circle cx="693.59457" cy="490.09438" r="7.69014" fill="#6c63ff" />
                        <circle cx="121.99614" cy="307.82101" r="53.51916" fill="#6c63ff" />
                        <path
        ...
        <div
            class="sm:w-4/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right
          ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
            <h2 class="p-4 text-4xl lg:text-5xl text-blue-700 leading-none mb-4 font-black ">
                Анализ ситуации. Консультация юриста.
            </h2>
            <p class="lg:text-lg mb-4 sm:mb-12 leading-relaxed text-justify sm:text-right">
                Срочно нужна консультация юриста? Нажмите кнопку «Запрос помощи» и введите номер
                телефона — мы перезвоним в течение 5 минут!
            </p>
            <Button href="/" on:click={newlead} class="py-3">
                <nobr>Запрос правовой помощи</nobr>
            </Button>
        </div>
    ...
    <br />
    <div class="container px-4 mx-auto text-lg">
        Первичная консультация юриста часто подразумевает проведение правового анализа текущей
        ситуации.<br />
        В зависимости от пожеланий клиента, результаты анализа предоставляются в устной или
        письменной форме.<br /><br />
        Правовой анализ ситуации — процедура ознакомления юриста с особенностями дела клиента
        (оформление наследства, земельный или жилищный спор, взыскание задолженности и пр.). В ходе
        работы специалист:
        <List items={listOneLine} />
        При необходимости юрист изучает сведения о последних изменениях в положениях
        законодательства, а также судебную практику по делам аналогичной тематики. Грамотно
        сформированная на начальных этапах работы позиция и продуманная стратегия поведения заметно
        повышают возможность успешного решения проблем клиента.
    </div>
