<script>
    ...
    const listOneLine = [
        ...
        {
            text: 'Ходатайство представляет собой прошение, направляемое в уполномоченный компетентный или вышестоящий орган, об оказании содействия в том или ином вопросе.',
            icon: 'check_circle_outline',
        },
    ];
</script>
...
<svelte:head>
    <title>Составление обращений в государственные органы</title>
</svelte:head>
...
<section class="body-font">
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    <div class="md:text-4xl text-2xl uppercase font-black">
                        Составление обращений в государственные органы
                    </div>
                    <div class="text-xl mt-4">
                        Нужна помощь в cоставлении ходатайства? Нажмите кнопку «Запрос помощи» и
                        введите номер телефона — мы перезвоним в течение 5 минут!
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Запрос на составление ходатайства" />
                        </Modal>
                    </div>
                </div>
                <div class="md:w-1/2 flex flex-col justify-center bg-dots">
                    <div class="shadow-2xl w-auto z-10 rounded mt-6 ml-4">
                        <svg
                            ...
                            viewBox="0 0 747.2108 570.00666"><path
            ...
            <br />
            <div class="text-xl">
                Заявления, жалобы, ходатайства граждан в совокупности называются обращениями.
                Они являются цивилизованными методами разрешения тех проблем, на которые люди
                обращают внимание органов власти, полиции, налоговиков, прокуратуры или других
                компетентных структур, и излагают обоснованные требования по их устранению.
