<script>
    ...
    const listOneLine = [
        {
            text:
                'На основании кредитных обязательств перед банками, финансовыми организациями либо физическими лицами.',
            icon: 'check_circle_outline',
        },
        {
            text: 'На соглашениях, заключенных в простой письменной форме.',
            icon: 'check_circle_outline',
        },
        {
            text:
                'На жалобе работника о невыплаченной или выплаченной не в полном объеме заработной плате.',
            icon: 'check_circle_outline',
        },
        {
            text:
        ...
        {
            text: 'На оспаривании ценных бумаг нотариусом.',
            icon: 'check_circle_outline',
        },
        {
            text: 'На сделках, заверенных нотариально.',
            icon: 'check_circle_outline',
        },
        {
            text: 'На факте задолженности по коммунальным платежам и услугам телефонной связи.',
            icon: 'check_circle_outline',
        },
        {
            text: 'На спорах по алиментным взысканиями на несовершеннолетних детей.',
            icon: 'check_circle_outline',
        },
        {
            text:
...
<svelte:head>
    <title>СТРАХОВАНИЕ ИПОТЕЧНОГО КРЕДИТА</title>
</svelte:head>
...
<section class="body-font">
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="text-xl mt-4">
                        ...
                        Мы – партнёры страховой компании «РЕСО-Гарантия», одного из лидеров рынка в
                        России. Агентство обладает широчайшей сетью филиалов по всей стране (около
                        1200 офисов и подразделений). В компании работает более 34 тысяч человек. В
                        числе партнёров компании есть такие крупные фирмы как «Swiss Re», «Hannover
                        Re», «Российская Национальная Перестраховочная Компания», Allian» и другие.
                        Клиентами агентства являются более 11 миллионов юридических и физических
                        лиц.
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Страхование ипотечного кредита" knoblabel="ПОЛУЧИТЬ СТРАХОВКУ" />
                        </Modal>
                    </div>
                </div>
            ...
            <div class="text-xl">
                <p class="leading-relaxed text-xl mb-4 pttext text-justify max-w-6xl">
                В качестве доверенного партнёра «РЕСО-Гарантия» мы оказываем <b>услуги по страхованию
                самого широкого профиля</b> под брендом агентства – автострахование (КАСКО, ОСАГО),
                медицинское страхование, туристическое страхование, страхование имущества,
                страхование жизни и т.д. Тем не менее <b>в центре нашего внимания – страхование
                ипотечного кредита</b>у. Являясь дочерней компанией успешного риелторского агентства
                «ТИТАН», мы прекрасно разбираемся во всех вопросах, связанных с рынком недвижимости.
                Поможем вам как с оформлением ипотеки, так и её страхованием, что является
                обязательным условием банков при заключении с ними кредитного договора. Если вы не
                получите страховку, то и в ипотеке вам откажут.

                <br /><br /> <text-justify>
                Существуют три вариации страхования ипотечного договора – страхование имущества,
                права собственности и жизни (здоровья). Первая страхует сам объект собственности от
                пожаров, взрывов, затоплений и иных повреждений жилья. Вторая поможет обезопасить
                ваши права от оспаривания их третьими лицами. Третья оформляется как гарантия на
                случай болезни, потери дееспособности или смерти владельца. Каждый из вариантов
                рекомендуется для страхования в зависимости от длительности ипотечного договора.
                <br /><br /> </text-justify>
                Поручите заботу о вашей безопасности нашим специалистам!
                <br /><br />
