<script>
    ...
    function newlead() {
        ...
        fetch(
            'https://urtitan.bitrix24.ru/rest/6/nukdgqcdzapnn3xy/crm.lead.add.json?fields[TITLE]=Лид с сайта - услуга 1 - ' +
...
<section class="py-5 px-5">
    <div class="container m-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
            ...
            <svg
                ...
                <g style="isolation:isolate">
                    <g id="Capa_1" data-name="Capa 1">
                        ...
                        <polygon
                            points="153.27 156.37 161.15 155.42 161.15 148.86 153.27 149.56
                          153.27 156.37"
                            style="fill:#afbad6" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#e7bfaa" />
                        <polygon
                            points="102.08 143.4 108.98 140.01 115.27 153.95 108.54 158.84
                          102.08 143.4"
                            style="fill:#afbad6" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#e7bfaa" />
                        <polygon
                            points="112.65 107.07 108.92 115.93 102.38 116.25 92.58 105.75
                          106.89 105.34 112.65 107.07"
                            style="fill:url(#linear-gradient-10)" />
                        <polygon
                            points="78.83 91.79 106.12 105.34 95.07 113.79 75.88 96.08 78.83
                          91.79"
                            style="fill:url(#linear-gradient-11)" />
                        <polygon
                            points="106.12 105.34 115.03 111.93 113.2 100.35 110.3 97.06 106.12
                          105.34"
                        ...
                        <path
                            ...
                            style="fill:#807fb4" />
                        <polygon
                            points="194.47 161.72 191.47 157.94 194.19 159.05 200.46 153.69
                          194.47 161.72"
                            style="fill:#fff" />
                        <polygon
                            points="194.47 184.26 191.47 180.47 194.19 181.59 200.46 176.23
                          194.47 184.26"
                            style="fill:#fff" />
                        <rect
                            x="205.33"
        ...
        <div
            class="sm:w-6/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right
          ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
            <h2 class="text-4xl lg:text-5xl text-blue-700 leading-none mb-4 font-black ">
                ЮРИДИЧЕСКИЙ ЦЕНТР ТИТАН
            </h2>
            <p class="lg:text-lg mb-4 sm:mb-12 leading-relaxed text-justify sm:text-right">
                «ТИТАН ЮрЦентр» – дочерняя компания АН »ТИТАН», одного из крупнейших риелторских
            ...
            <Button href="uslugi" on:click={newlead} class="py-3 px-12">
                <nobr>Подробнее об услугах</nobr>
            </Button>
        </div>
    </div>
    <br /><br />
    <b> © «ТИТАН ЮРЦЕНТР»:</b> +7 (4822) 395-429,
                    mail@urtitan.ru. Юридическая помощь в операциях с недвижимостью (г. Тверь, проспект
                    Победы, д. 3, офис 502-а).
     <!-- 
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                <div class="p-8 shadow rounded">
                    ...
                    <p class="leading-loose">
                        In et sagittis risus, sed molestie sapien. Suspendisse potenti. Sed
                        pharetra, leo quis dignissim tristique, arcu arcu varius libero, ut
                        vestibulum sapien odio facilisis nunc.
                    </p>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
