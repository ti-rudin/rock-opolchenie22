...
<svelte:head>
    <title>Составление исковых заявлений</title>
</svelte:head>
...
<section class="body-font">
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="text-xl mt-4">
                        Нужна помощь в cоставлении искового заявления? Нажмите кнопку «Запрос
                        помощи» и введите номер телефона — мы перезвоним в течение 5 минут!
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Запрос на составление искового заявления" />
                        </Modal>
                    </div>
                </div>
            ...
            <br />
            <div class="text-xl">
                Исковое заявление призвано защитить права истца. При его подаче нужно учесть
                множество факторов. Заявление составляют согласно определенной законодательством
                форме и подают в суд с пакетом сопроводительных документов, при соблюдении порядка
                уведомления ответчиков, сроков исковой давности и пр. Также очень важную роль играет
                текст документа.
                <br /><br />
                Решение нередко выносится в пользу истца именно благодаря исковому заявлению,
                составленному грамотно, логично, структурированно, с приложением ссылок на правовую
                базу, а также с учетом человеческого фактора. Чем более полно и понятно для ранее не
                знакомого с ситуацией человека (т. е. судьи) изложено описание событий и требований,
                тем быстрее судья разберется в сути дела и примет по нему законное и обоснованное
                решение.
                <br /><br />
                По общему мнению, исковое заявление подается в суд, если конфликт истца и ответчика
                не удалось разрешить в досудебном порядке, т. е. после предъявления письменной
                претензии в адрес ответчика. Однако в большинстве случаев претензионная, досудебная,
                стадия не является обязательной. Неправильно оформленное исковое заявление будет
                возвращено либо оставлено без движения.
                <br /><br />
                Чтобы добиться нужного результата без лишних временных и финансовых затрат, доверьте
                составление документа профессионалу.
            </div>
        </div>
        <hr />
        <UslugiPretenz />
