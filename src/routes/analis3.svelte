...
<svelte:head>
    <title>Анализ ситуации, консультация</title>
</svelte:head>
...
<section class="body-font">
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Запрос правовой помощи" />
                        </Modal>
                    </div>
                </div>
            ...
            <br />
            <div class="text-xl">
                Первичная консультация юриста часто подразумевает проведение правового анализа
                текущей ситуации и разработку рекомендаций к дальнейшим действиям клиента.<br />
                В зависимости от пожеланий клиента, результаты анализа предоставляются в устной или
                письменной форме.<br /><br />
                Правовой анализ ситуации (юридическое заключение) – процедура аналитического
                исследования определенных обстоятельств описанных клиентом, для определения
                юридических последствий, которые могут наступить в следствии юридически значимых
                действий участников конкретной ситуации.<br />
                ...
                законодательства, судебную практику по делам аналогичной тематики. Также в ходе
                консультации специалист зачастую принимает решение о необходимости проведения
                правового анализа документации, относящейся к делу. Комплексный подход позволяет уже
                на начальных этапах работы грамотно сформировать позицию и продумать стратегию
                поведения, что заметно повышает возможность успешного решения проблем клиента.
            </div>
        </div>
        <hr />
        <UslugiPravanalis />
