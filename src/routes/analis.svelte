<script>
    ...
    import UslugiPravanalis from '../components/UslugiPravanalis.svelte';
    ...
    const listOneLine = [
        {
            text: 'беседуя с клиентом, собирает первичную информацию по ситуации',
            icon: 'check_circle_outline',
        },
        {
            text: 'изучает предоставленную документацию',
            icon: 'check_circle_outline',
        },
        {
            text:
                'консультирует клиента о способах и порядке получения недостающих или необходимых справок, отчетов, ответов на заявления и т. д.',
            icon: 'check_circle_outline',
        },
        {
            text: 'выполняет аналитическое исследование обстоятельств ситуации',
            icon: 'check_circle_outline',
        },
        {
            text:
                'на основании профессионального опыта, знания законов и судебной практики формирует и предлагает клиенту потенциальные варианты решения его проблемы или задачи, выстраивает стратегию дальнейшего поведения',
            icon: 'check_circle_outline',
        },
        {
            text:
                'в случае необходимости перенаправляет вас к профессиональному риелтору, который будет курировать вашу сделку в области недвижимости за пределами компетенций юриста.',
            icon: 'check_circle_outline',
        },
    ];

    //mport Dialog from 'smelte/src/components/Dialog';
</script>
...
<svelte:head>
    <title>АНАЛИЗ СИТУАЦИИ, КОНСУЛЬТАЦИЯ ЮРИСТА</title>
</svelte:head>
    ...
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    <div class="md:text-4xl text-2xl uppercase font-black">
                        Анализ ситуации, Консультация юриста
                    </div>
                    <div class="text-xl mt-4 text-justify">
                        Срочно нужна консультация юриста по вопросам недвижимости? Свяжитесь с
                        нашими специалистами по телефону +7 (4822) 395-429, и мы вам поможем!
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Запрос правовой помощи" knoblabel="ЗАПИСАТЬСЯ НА КОНСУЛЬТАЦИЮ"/>
                        </Modal>
                    </div>
                </div>
                <div class="md:w-1/2 flex flex-col justify-center bg-dots">
                    <div class="shadow-2xl w-auto z-10 rounded mt-6 ml-4">
                        <svg
                            ...
                            viewBox="0 0 893.86671 645.61588"><path
                            ...
                            <path
                                ...
                                transform="translate(-153.06664 -127.19206)"
                                fill="#2f2e41" />
                            <circle cx="797.16693" cy="314.52053" r="50.12206" fill="#2196f3" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-153.06664 -127.19206)"
                                fill="#3f3d56" />
                            <circle cx="693.59457" cy="490.09438" r="7.69014" fill="#2196f3" />
                            <circle cx="121.99614" cy="307.82101" r="53.51916" fill="#2196f3" />
                            <path
            ...
            <div class="text-xl text-justify">
                Операции с недвижимостью – мероприятия комплексные и состоящие из множества нюансов.
                Самостоятельно осуществлять сделки-купли продажи, не имея за спиной
                профессионального риелтора или грамотного юриста, довольно рискованно, поскольку
                даже сейчас можно наткнуться на недобросовестного продавца или мошенника-покупателя.
                В ходе подписания соглашения могут вскрыться ранее не известные обстоятельства, в
                результате которых сделка будет аннулирована, а вы понесёте финансовые потери и
                убытки. Наш юрист по недвижимости поможет избежать потенциальных рисков и
                потраченных нервов. Даже простая консультация уже станет отличным подспорьем для
                того, чтобы провести операцию купли-продажи как можно более гладко.
                <br /><br />
                Первичная консультация юриста подразумевает проведение правового анализа текущей
                ситуации клиента и разработку рекомендаций к его дальнейшим действиям. В зависимости
                от пожеланий клиента, результаты анализа предоставляются в устной или письменной
                форме. При первой встрече с юристом вам следует предоставить полный комплект
                документов, касающийся вашего дела. Специалист по недвижимости внимательным образом
                изучит их и предоставит рекомендации для решения имеющейся проблемы.
                <br /><br />
                Вырабатывая рекомендации к дальнейшим действиям клиента, в ходе работы юрист:
                <List items={listOneLine} />
                <b>Внимание: помимо услуг юриста, настоятельно рекомендуем подыскать себе грамотного
                риелтора. Юридический центр «ТИТАН» является дочерней компанией одного из крупнейших
                риелторских агентств в Твери и Тверской области, в связи с чем вам не нужно идти в
                другое отдельное место. Услуги профессионального риелтора предоставляются по первому
                запросу клиента.</b>
            </div>
            <div class="mt-5 mb-6 h-10 duration-100">
                <Modal>
                    <Content leadmes="Записаться на консультацию к юристу" knoblabel="ПОМОЩЬ ЮРИСТА" />
                </Modal>
            </div>
        </div>
        <hr />
