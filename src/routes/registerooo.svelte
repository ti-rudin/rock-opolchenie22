<script>
    ...
    const listOneLine = [
        {
            text:
                'Консультируем и помогаем с разрешением спорных  и конфликтных ситуаций',
            icon: 'check_circle_outline',
        },
        {
            text:
                'Собираем и подаём весь комплект документов, предварительно проанализировав его на предмет ошибок и корректность составления',
            icon: 'check_circle_outline',
        },
        {
            text:
                'Сопровождаем вас вплоть до момента получения вами свидетельства о регистрации',
            icon: 'check_circle_outline',
        },
        {
            text:
                'Помогаем с внесением изменений в ЕГРП',
            icon: 'check_circle_outline',
        },
        {
            text:
                'Помогаем с постановкой объектов недвижимости на кадастровый учёт',
            icon: 'check_circle_outline',
        },
    ];
</script>
...
<svelte:head>
    <title>РЕГИСТРАЦИЯ СОБСТВЕННОСТИ</title>
</svelte:head>
    ...
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="text-xl mt-4 text-justify">
                        Государственная регистрация прав на недвижимое имущество – обязательная
                        процедура, в рамках которой происходит ваше признание в качестве
                        полноправного владельца собственности. Прежде всего, необходимо поставить
                        объект на учёт в ЕГРН (в Единый государственный реестр недвижимости). При
                        этом в базу данных вносятся адрес, кадастровый номер, площадь и другие
                        сведения об имуществе и его правообладателе. Без осуществления этой
                        процедуры вы не сможете ни продать недвижимость, ни сдать его в аренду, ни
                        подарить ни даже оставить в наследство.
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content
                                leadmes="Запрос на регистрацию прав"
                                knoblabel="НУЖНА ПОМОЩЬ С РЕГИСТРАЦИЕЙ" />
                        </Modal>
                    </div>
                </div>
                <div class="md:w-1/2 flex flex-col justify-center bg-dots">
                    <div class="shadow-2xl w-auto z-10 rounded mt-6 ml-4">
                        <svg
                            id="ed87c231-0a5e-4106-ab1d-a76c85fd660b"
                            data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 601.79779 539"><path
                            ...
                            <path
                                ...
                                transform="translate(-299.1011 -180.5)"
                                fill="#2f2e41" />
                            <circle cx="363.88604" cy="217.15117" r="51.76199" fill="#2196f3" />
                            <path
                            ...
                            <path
                                ...
                                fill="#2f2e41" />
                            <path
                                id="a8ac6166-3ec4-44bd-a940-12ae5b8b67a0"
                                data-name="Path 336"
            ...
            <div class="text-xl text-justify">
                Происходит этот процесс путём подачи довольно объёмного комплекта документов. После
                этого вы получаете свидетельство, закрепляющее ваше право распоряжения имуществом.
                Обратившись к нам, вы избавите себя от лишней и неприятной бюрократической волокиты.
                Мы сами соберём за вас все бумаги и подадим их в Росреестр или МФЦ, а также
                проконсультируем по любым связанным с регистрацией вопросам.
                <br /><br />
                <b>Что мы делаем:</b>
                <List items={listOneLine} />
                <br />
                В процедуре регистрации сделок с недвижимостью мы можем выступать в качестве вашего
                представителя. Для этого потребуется доверенность, заверенная у нотариуса, однако,
                прибегнув к нашим услугам в качестве вашего доверенного лица, вы избавите себя от
                довольно трудоёмкого и времязатратного процесса. Положитесь на нас, и ваше имущество
                всегда будет в сохранности! Грамотная организация процедуры регистрации является
                залогом того, что права клиентов на недвижимость не будут оспорены третьими лицами,
                поэтому в этом вопросе не стоит пренебрегать услугами юридических специалистов.
                <div class="mt-5 mb-6 h-10 duration-100">
                    <Modal>
                        <Content leadmes="Запрос на регистрацию прав" knoblabel="НАПИСАТЬ НАМ" />
                    </Modal>
                </div>
