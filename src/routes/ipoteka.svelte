<script>
    ...
    const listOneLine = [
        {
            text:
                'Оцениваем финансовые возможности клиентов, проверяем их кредитную историю',
            icon: 'check_circle_outline',
        },
        {
            text: 'Составляем список рекомендаций по оформлению ипотечного кредита',
            icon: 'check_circle_outline',
        },
        {
            text: 'Предлагаем самые выгодные для клиента программы и тариф, вместе согласовываем план действий. Проверяем возможности участия в различных льготных программа',
            icon: 'check_circle_outline',
        },
        {
            text: 'Собираем, оформляем и подаём все необходимые документы',
            icon: 'check_circle_outline',
        },
        {
            text: 'Делаем подсчёт стоимости всех расходных статей (ипотека, оформление, страхование и т.д.)',
            icon: 'check_circle_outline',
        },
        {
            text: 'Осуществляем поиск объекта недвижимости, соответствующего запросам клиента и условиям, предлагаемых банком',
            icon: 'check_circle_outline',
        },
        {
            text: 'Помогаем в урегулировании спорных ситуаций между вами и банком',
            icon: 'check_circle_outline',
        },
        {
            text: 'Производим сопровождение ипотечной сделки и операции купли-продажи жилья (при необходимости)',
            icon: 'check_circle_outline',
        },
    ];
</script>
...
<svelte:head>
    <title>ОФОРМЛЕНИЕ ИПОТЕКИ</title>
</svelte:head>
    ...
    <div class="container px-5 mx-auto section-p flex flex-col">
        <div class="m-auto max-w-6xl p-8">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <div class="text-xl mt-4 text-justify">
                        Ипотечный кредит и любые операции, связанные с его сопровождением, являются
                        одним из ключевых направлений работы как нашего юридического центра, так и
                        аффилированного с ним агентства недвижимости «ТИТАН». Несмотря на то, что
                        банки сегодня предлагают самые разнообразные варианты кредитования по
                        ипотеке, получение наиболее благоприятного из них может оказаться серьёзной
                        проблемой. Вам могут не выдать ту сумму, на которую вы рассчитывали. Или же
                        процентная ставка окажется гораздо выше ожидаемой. В обоих случаях вы
                        понесёте серьёзные финансовые издержки и либо не сможете приобрести
                        недвижимость, которую себе присмотрели, либо, вполне вероятно, окажетесь не
                        в состоянии осуществлять ежемесячные выплаты, прописанные в договоре. При
                        самом неблагоприятном варианте банк и вовсе откажет вам в оформлении
                        ипотеки. Именно для предотвращения любого из этих возможных событий и
                        следует обратиться за помощью к специалистам.
                    </div>
                    <div class="mt-5 mb-6 h-10 duration-100">
                        <Modal>
                            <Content leadmes="Оформление ипотеки" knoblabel="ПОМОЧЬ С ИПОТЕКОЙ" />
                        </Modal>
                    </div>
                </div>
            ...
            <div class="text-xl text-justify">
                Самостоятельно разобраться во всех тонкостях программ финансирования, предлагаемых
                банками, неподготовленному человеку будет довольно сложно. Мы поможем выбрать
                наиболее выгодный для вас тариф в соответствии с вашими запросами и ожиданиями. Наша
                компания сотрудничает с многочисленными банками, расположенными в Твери, что может в
                значительной степени облегчить получение кредита для наших клиентов. Между нами и
                Городским ипотечным центром заключено соглашение, что даёт вам возможность подать
                заявку на оформление ипотеки даже в те банковские учреждения, филиалы которых
                отсутствуют в нашем городе. Кроме того, мы оказываем услуги по страхованию
                ипотечного кредита от лица «РЕСО-Гарантия», одной из крупнейших страховых компаний в
                стране. 
                <br /><br />
                Проблемы при оформлении ипотеки могут быть самыми разнообразными. Вам могут
                помешать плохая кредитная история, неправильно подготовленные документы, наличие
                неофициального дохода, невозможность внесения первоначального взноса. Наши
                специалисты готовы подключиться к любой самой нестандартной ситуации наших клиентов.
                Как правило, процедура начинается с подготовки, сбора и подачи всей необходимой
                документации. Иногда банки могут отказывать в оформлении ипотеки без объяснения
                причины. В подобной ситуации также рекомендуем обращаться к нам!
                <br /><br />
                <b>Как мы помогаеи</b>
                <List items={listOneLine} />
                <div class="mt-5 mb-6 h-10 duration-100">
                    <Modal>
                        <Content leadmes="Оформление ипотеки" knoblabel="НАПИСАТЬ НАМ" />
                    </Modal>
                </div>
